    ...
    <section id="about" className="py-10 md:py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-3">
              {[about1, about2, about3, about4].map((src, i) => (
                <div
                  key={i}
                  className="rounded-xl overflow-hidden shadow-card aspect-square">
                  <img
                    src={src}
          ...
          {/* Right — copy */}
          <div className="space-y-4 md:space-y-6 animate-fade-in-up pt-6 md:pt-0">
            ...
            <p className="text-muted-foreground leading-relaxed">
              At Ruty's Makeovers, we believe every woman deserves to feel like
              a queen. Based in Port Harcourt, Nigeria, we specialize in
              transforming beauty visions into reality — from breathtaking
              bridal looks and gele tying to professional wig making,
              microblading, and lash extensions.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              With years of experience and a passion for perfection, our team
              delivers personalized beauty experiences that celebrate your
              unique style. Whether it's your wedding day, a special event, or
              just a day to pamper yourself — we've got you covered. We also
              offer home service and travel for your convenience.
            </p>
